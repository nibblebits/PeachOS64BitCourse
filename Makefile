...
FILES = ./build/kernel.asm.o ./build/kernel.o ./build/memory/heap/multiheap.o ./build/memory/paging/paging.o  ./build/idt/idt.o ./build/idt/idt.asm.o ./build/memory/paging/paging.asm.o ./build/io/io.asm.o ./build/string/string.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/memory.o
INCLUDES = -I./src
